...
class FFCalendar extends StatefulWidget {
  const FFCalendar({
    Key? key,
    required this.color,
    this.onChange,
  ...
  @override
  State<StatefulWidget> createState() => _FFCalendarState();
}

class _FFCalendarState extends State<FFCalendar> {
...
class CalendarHeader extends StatelessWidget {
  ...
  Widget _buildDateWidget() => Expanded(
        child: Text(
          (DateFormat.yMMMM(locale).format(focusedDay)).toUpperCase(),
