...
/// the week.
class _DayPicker2 extends StatefulWidget {
  ...
  @override
  _DayPicker2State createState() => _DayPicker2State();
}

class _DayPicker2State extends State<_DayPicker2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GridView.custom(
        ...
        gridDelegate: _dayPicker2GridDelegate,
...
class _DayPicker2GridDelegate extends SliverGridDelegate {
  const _DayPicker2GridDelegate();
  ...
  @override
  bool shouldRelayout(_DayPicker2GridDelegate oldDelegate) => false;
}

const _DayPicker2GridDelegate _dayPicker2GridDelegate =
    _DayPicker2GridDelegate();
