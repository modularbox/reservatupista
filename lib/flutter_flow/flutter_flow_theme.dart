...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2B78DC);
  late Color secondary = const Color(0xFF5A9BEE);
  late Color tertiary = const Color(0xFFFFFFFF);
  // late Color alternate = const Color(0xFFFF9C41);
  late Color alternate = const Color(0xFF2B78DC);
  ...
  late Color aguamarina = const Color.fromARGB(255, 176, 241, 234);
  late Color proveedor = const Color(0xFF46EF98);
  late Color tarifas = const Color(0xFF4D39D20);
}
