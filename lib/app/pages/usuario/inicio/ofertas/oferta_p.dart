...
import 'package:reservatu_pista/app/pages/usuario/inicio/ofertas/oferta_c.dart';
...
class OfertaWidget extends GetView<OfertaController> {
  const OfertaWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return NavbarYAppbarUsuario(
        title: 'Oferta',
        page: TypePage.None,
        child: Expanded(child: _OfertaWidgetState()));
  }
}

class _OfertaWidgetState extends GetView<OfertaController> {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  OfertaController get _model => controller;
