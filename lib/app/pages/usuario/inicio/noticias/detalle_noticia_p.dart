...
import 'package:reservatu_pista/app/pages/usuario/inicio/noticias/detalle_noticia_c.dart';
...
class DetalleNoticiaWidget extends GetView<DetalleNoticiaController> {
  ...
  Widget build(BuildContext context) {
    return NavbarYAppbarUsuario(
        title: 'Noticia',
        page: TypePage.None,
        child: Expanded(child: _DetalleNoticiaWidgetState()));
  }
}

class _DetalleNoticiaWidgetState extends GetView<DetalleNoticiaController> {
