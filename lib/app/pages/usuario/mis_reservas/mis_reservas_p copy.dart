...
class MisReservasPage2 extends GetView<MisReservasController2> {
  MisReservasPage2({Key? key}) : super(key: key);
  MisReservasController2 get self => controller;
                  ...
                  Expanded(
                    child: Listener(
                      onPointerSignal: (event) {
                        ...
                        print(
                            'self.isThrottling.value ${self.isThrottling.value}');
