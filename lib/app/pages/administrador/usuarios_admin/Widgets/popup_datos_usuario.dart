...
class AdminDatosUsuarioWidget extends GetView<AdminUsuariosController> {
  const AdminDatosUsuarioWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return _AdminDatosUsuarioWidgetState();
  }
}

class _AdminDatosUsuarioWidgetState extends GetView<AdminUsuariosController> {
  Socio? socio;
  final datos = [
    "Nombre: ",
    "Nivel: ",
